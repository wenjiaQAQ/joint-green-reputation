%% This function is for cutting off with a neighbor that of the lowest JR
% Input: id of the node, catogory of the node, 

function cutoffNeighbor(i, currentAdjMatrix, currentJRValues)
